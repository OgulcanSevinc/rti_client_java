...
public class WindowClient extends JFrame {
    ...
    public void setArticle(String article, float prix, int stock, String image) {
        ...
        ImageIcon imageIcon = new ImageIcon("C:\\Users\\_Izanami_\\Desktop\\JavaCliient\\src\\images\\" + image);
    ...
    public void setController(ControllerView mainWindowController)
    {
        pushButtonLogin.addActionListener(mainWindowController);//OK
        pushButtonLogout.addActionListener(mainWindowController);//OK
        pushButtonAcheter.addActionListener(mainWindowController);
        pushButtonPrecedent.addActionListener(mainWindowController);//OK
        pushButtonSuivant.addActionListener(mainWindowController);//OK
